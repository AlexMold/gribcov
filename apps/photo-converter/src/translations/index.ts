export const translations = {
  ...
  ro: {
    ...
    editor: {
      ...
      applyCrop: "Aplicați",
      cancelCrop: "Anulați",
      resetFilters: "Resetați",
      colorFilters: "Culoare",
  ...
  ru: {
    ...
    app: {
      ...
      description:
        "Конвертируйте изображения между HEIC, JPG, PNG, WebP и другими форматами. Бесплатно, быстро и безопасно.",
    },
    footer: {
...
export const metadataTranslations = {
  ...
  es: {
    ...
    description:
      "Convertidor de imágenes gratuito. Convierte HEIC a JPG/JPEG, PNG a WebP, crea GIFs animados y más. Rápido, seguro y sin registro.",
    ogTitle: "Convierte HEIC a JPG, PNG a WebP y más | Convertidor de Imágenes",
    ogDescription:
      "Convertidor en línea gratuito para imágenes HEIC, JPG, PNG, WebP. Convierte cualquier formato al instante. Sin registro, sin límites.",
  },
  ru: {
  ...
  ro: {
    ...
    description:
      "Convertor de imagini gratuit online. Convertește HEIC în JPG/JPEG, PNG în WebP, creează GIF-uri animate și mai mult. Rapid, sigur și fără înregistrare.",
    ogTitle: "Convertește HEIC în JPG, PNG în WebP și altele | Convertor de Imagini",
    ogDescription:
      "Convertor online gratuit pentru imagini HEIC, JPG, PNG, WebP. Convertește orice format instant. Fără înregistrare, fără limite.",
  },
};
